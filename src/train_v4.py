...
def train_model(class_weights):
    ...
    torch.save(model.state_dict(), 'models/ecg_model_v4.pth')
    print("Model saved to models/ecg_model_v4.pth")

if __name__ == '__main__':
    # --- Calculate New "Dampened" Weights ---
    ...
    print(f"Using new dampened class weights: {weights}")
